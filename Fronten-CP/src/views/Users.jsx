...
function Users() {
  const { users, peticionAllUsers } = useContext(Context);
  ...
  return (
    <>
      ...
      <main className="pt-[7.5vh] h-auto w-full bg-gris-neutro relative min-h-[100vh] flex justify-center items-center">
